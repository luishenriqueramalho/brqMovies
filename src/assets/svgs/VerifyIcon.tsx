...
export const VerifyIcon: React.FC = () => (
  <Svg width="24" height="24" x="0" y="0" viewBox="0 0 120 120">
    <G>
      ...
      <Path
        fill="#00d566"
        d="m44 53.6 12.5 14.3 25.6-20.6"
        opacity="1"
        data-original="#00d566"
      ></Path>
      <Path
        fill="#ffffff"
        d="M53.5 75.3c-1.4 0-2.8-.6-3.8-1.7L37.2 59.3c-1.8-2.1-1.6-5.2.4-7.1 2.1-1.8 5.2-1.6 7.1.4l9.4 10.7L76 45.7c2.1-1.7 5.3-1.4 7 .8s1.4 5.3-.8 7L56.6 74.2c-.9.7-2 1.1-3.1 1.1z"
        opacity="1"
